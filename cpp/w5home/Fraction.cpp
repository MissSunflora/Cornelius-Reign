...
namespace sict {
	...
	//	cout << endl << "         creation: numerator= " << m_numerator << " denomerator= " << m_denominator << endl << endl;
	}
	...
	Fraction::Fraction(int numerator, int denominator)
	{
		if (numerator > 0  && denominator > 0 )
		{
			...
			reduce();
	//		cout << endl << "          successfully copied: numerator= " << m_numerator << " denomerator= " <<m_denominator << endl << endl;
		}
		else
		{
			*this = Fraction();
	//		cout << endl << "          Set objects to safe empty state. numerator= " << m_numerator << " denomerator= " << m_denominator << endl << endl;
		}
	}
	...
	{
		bool valid = (isEmpty() == false) && (rhs.isEmpty() == false);
		bool same = (m_denominator == rhs.m_denominator) &&	(m_numerator == rhs.m_numerator);
